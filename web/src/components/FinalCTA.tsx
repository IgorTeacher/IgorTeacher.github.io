export default function FinalCTA() {
  return (
    <section className="section-spacing bg-emerald-600">
      <div className="mx-auto max-w-4xl px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          <a 
            ...
            className="bg-white text-emerald-600 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-neutral-50 transition-colors transform hover:scale-105"
          >
          ...
          <a 
            ...
            className="border-2 border-white text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-white hover:text-emerald-600 transition-colors"
          >
            Support My Teaching
          </a>
        </div>

        <div className="grid md:grid-cols-3 gap-6 text-center text-emerald-100">
          <div>
