...
export default function Pricing() {
  ...
  return (
    <section id="pricing" className="py-20 bg-gradient-to-b from-blue-50/20 via-transparent to-transparent dark:from-blue-900/20">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div className="bg-blue-100 dark:bg-blue-900 p-8 rounded-2xl border-2 border-blue-500 relative">
            ...
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold text-neutral-800 dark:text-white mb-2">{t('pricing.trial.title')}</h3>
              <p className="text-neutral-700 dark:text-neutral-300">{t('pricing.trial.subtitle')}</p>
            </div>
            ...
            <ul className="space-y-4 mb-8">
              {(Array.isArray(t('pricing.trial.features')) ? t('pricing.trial.features') : [
                ...
                <li key={index} className="flex items-center gap-3">
                  ...
                  <span className="text-neutral-800 dark:text-neutral-300">{feature}</span>
                </li>
              ))}
            </ul>
