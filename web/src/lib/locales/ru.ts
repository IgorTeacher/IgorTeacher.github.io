export const ru = {
  ...
  about: {
    ...
    introduction: {
      greeting: "Привет, я Ихар (Игорь) Аусиани. Я преподаю английский и немецкий уже более 12 лет, и за это время я также сам изучал языки — фарси, польский, французский и даже немного китайский. Я упоминаю это, потому что я действительно знаю взлеты и падения изучения языков изнутри.",
